const API_GEOLOCATION_URL = "https://geocoding-api.open-meteo.com/v1/search?name=Berlin&count=10&language=en&format=json  "
...
async function getCityCoordinates(cityName){
    ...
    apiUrl.searchParams.append("language", "en"); // Optional, based on the language you want
...
function createWeatherPanel(weather, isToday){
    ...
    const panelClass = isToday ? "today" : "forecasts";
    ...
    temp.innerText = `Temperatrura: ${weather.temp}°C`;
